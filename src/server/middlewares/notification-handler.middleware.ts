...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'job_application.create': { roles: ['recruiter', 'admin'], key: 'job_application', tenantPath: [], userPath: [] },
  'job_posting.create': { roles: ['recruiter', 'admin'], key: 'job_posting', tenantPath: [], userPath: [] },
  'job_application_status.update': {
...
const tenantRoles: string[] = ['recruiter', 'admin'];
