  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover, apply, and elevate your career with LocalJobs. A dedicated portal for job listings and applications, tailored to your local area. Your journey towards a fulfilling career starts here."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxqb2IlMjBwb3J0YWx8ZW58MHx8fHwxNjk2MzQ0MDQ5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover, apply, and elevate your career with LocalJobs. A dedicated portal for job listings and applications, tailored to your local area. Your journey towards a fulfilling career starts here.`}
            </Text>
            <Box
